...
EOF
	...
	wget https://github.com/sayhello023/trojan-atrandys/raw/master/web.zip >/dev/null 2>&1
	...
	#下载trojan客户端
	wget https://github.com/sayhello023/trojan-atrandys/raw/master/trojan-cli.zip >/dev/null 2>&1
